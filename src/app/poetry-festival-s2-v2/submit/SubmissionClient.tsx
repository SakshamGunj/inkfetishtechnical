...
export default function PoetrySubmissionClient() {
    ...
    const checkExistingSession = async () => {
      ...
      if (savedSession) {
        try {
          ...
          // For V2, we trust the local session status as it's a free portal
  ...
  const initiatePayment = async (planType: 'single' | 'double') => {
    ...
    try {
      // Step 1: Mocking order creation or just going straight to confirmed
      const mockOrderId = 'FREE_' + Math.random().toString(36).substr(2, 9).toUpperCase();
      ...
      showToast('Access granted! Welcome to Poetry Festival S2 (Free Edition).', 'success');
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 w-full max-w-4xl mx-auto items-stretch">
          ...
          >
            <div className="p-6 md:p-8 flex flex-col flex-1">
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase">1 Poem</span>
          ...
          >
            ...
            <div className="p-6 md:p-8 flex flex-col flex-1 relative z-10">
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase">2 Poems</span>
                <div className="flex flex-col">
                  <span className="text-gold/80 text-[8px] font-black uppercase tracking-widest">Most Popular</span>
                </div>
              </div>
      ...
      >
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/20 px-4 py-1.5 rounded-full mb-6">
            ...
            <span className="text-gold text-[10px] uppercase tracking-[0.3em] font-black">Double Entry — Free Edition</span>
          </div>
            ...
            {poemSession?.poem1 ? (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-1">
                  <Link
                    href={`/poetry-festival-s2-v2/read/${poemSession.poem1.id}`}
          ...
          >
            ...
            {poemSession?.poem2 ? (
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-1">
                  <Link
                    href={`/poetry-festival-s2-v2/read/${poemSession.poem2.id}`}
                    className="flex-1 bg-white/5 border border-white/10 text-white/70 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-white/10 transition-all flex items-center justify-center gap-1.5"
                  >
                    <Eye className="w-3 h-3" /> Read
                  </Link>
      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            {poemSession.poem1 && (
              <div className="bg-white/5 border border-gold/20 p-6 rounded-2xl text-left">
                ...
                <div className="flex gap-2">
                  <Link href={`/poetry-festival-s2-v2/read/${poemSession.poem1.id}`}
            ...
            {poemSession.poem2 && (
              <div className="bg-white/5 border border-gold/20 p-6 rounded-2xl text-left">
                ...
                <div className="flex gap-2">
                  <Link href={`/poetry-festival-s2-v2/read/${poemSession.poem2.id}`}
                    className="flex-1 bg-gold text-black py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-white transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-gold/20">
                    <Eye className="w-3 h-3" /> Read Entry
                  </Link>
                </div>
        ...
        {plan !== 'double' && (
          <div className="flex justify-center mb-8">
            <Link 
              href={`/poetry-festival-s2-v2/read/${submittedData?.id || ''}`}
          ...
          {isRegistering ? (
            ...
            >
              ...
              <div className="text-[#EAA134] font-black tracking-[0.3em] uppercase text-xs animate-pulse mb-3">
                {paymentStatus === 'creating' && 'Securing Your Entry...'}
                {paymentStatus === 'verifying' && 'Granting Access...'}
              ...
              {paymentStatus === 'verifying' && (
                <p className="text-white/30 text-[10px] max-w-xs text-center leading-relaxed">
                  Initializing your workspace. Do not close this tab.
                </p>
              )}
