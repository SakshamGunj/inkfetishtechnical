...
"margins_1785089041717_r3c6i",
"margins_1785088394895_8sby0",
"margins_1785088113830_ljp2h",
...
"margins_1785169633926_bcjv3",
"margins_1785125134811_0my75",
"margins_1785102081345_vwdlv",
"margins_1785092640215_bjckq",
"margins_1785261401035_iakz3",
"margins_1785259552849_iq9vj",
"margins_1785253233537_vbbn5",
"margins_1785223102763_ge3ya",
"margins_1785213404070_5ecbc"
];

// Ensure unique IDs in case of any accidental duplicates
const uniqueIds = [...new Set(orderIds)];

async function generateCsv() {
  console.log(`Starting recovery for ${uniqueIds.length} unique orders...`);
  ...
  fs.writeFileSync('margins_final_updated_orders.csv', csvContent);
  console.log(`\n✅ Done! Recovered ${successCount}/${uniqueIds.length} orders successfully.`);
  console.log('Saved to margins_final_updated_orders.csv');
}
