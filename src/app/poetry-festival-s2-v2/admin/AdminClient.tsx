...
export default function AdminClient() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (password === 'ADMINPORTALINKFETISH12' || password === 'admin123') { setAuthenticated(true); fetchSubmissions(); }
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col md:flex-row font-sans overflow-hidden">
      ...
      <div className={`w-full md:w-80 shrink-0 border-r border-white/10 flex-col h-screen bg-[#0a0a0a] z-20 ${selectedSubmission ? 'hidden md:flex' : 'flex'}`}>
        ...
        <div className="p-4 border-b border-white/10 shrink-0 bg-[#111]">
          ...
          <p className="text-[9px] text-[#555] text-center mt-2 uppercase tracking-wider">
            Reads all {submissions.length} submissions directly · Fast
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {loading ? (
            ...
            <div className="divide-y divide-white/5">
              {submissions.map((sub) => (
                <button key={sub.id} onClick={() => setSelectedSubmission(sub)}
            ...
            <div className="flex-1 overflow-auto bg-[#0f0f0f] custom-scrollbar relative">
              <div className="min-w-[600px] p-4 sm:p-10 flex flex-col items-center justify-start gap-12 absolute inset-0">
                <div ref={paperRef} className="bg-transparent shrink-0">
                  <div className="bg-white text-black relative mx-auto"
                    style={{ width: '559px', minHeight: '794px', padding: '64px', fontFamily: '"Times New Roman", Times, serif', lineHeight: '1.5', fontSize: '12px', boxShadow: '0 10px 40px rgba(0,0,0,0.5)', boxSizing: 'border-box' }}>
                    ...
                    <div className="parsed-tiptap-content" style={{ wordWrap: 'break-word' }}
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .parsed-tiptap-content blockquote { border-left: 3px solid rgba(0,0,0,0.2); padding-left: 1rem; margin-left: 0; font-style: italic; color: rgba(0,0,0,0.7); }
