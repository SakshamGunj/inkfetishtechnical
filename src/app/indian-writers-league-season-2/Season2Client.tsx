...
const Step4Dashboard = ({ formData, setStep, setSubmissionType, setSubmitStatus }: { formData: FormData, setStep: (s: number) => void, setSubmissionType: (type: 1 | 2) => void, setSubmitStatus: (s: 'idle' | 'submitting' | 'success' | 'error') => void }) => (
    ...
    <div className="max-w-4xl mx-auto px-4 pt-32 md:pt-40 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            {/* Entry 2 Card */}
            <div className={`bg-black/60 border border-[#E0C097]/30 backdrop-blur-md rounded-xl p-8 shadow-2xl relative overflow-hidden transition-all hover:border-[#FFD700]/50 hover:shadow-[0_0_30px_rgba(255,215,0,0.15)] ${formData.plan === 599 ? 'border-[#FFD700]/60' : 'border-[#420C0C]'}`}>
                {formData.plan !== 599 && (
