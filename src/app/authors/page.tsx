...
const authors = [
  ...
  { name: 'Thalir', slug: 'thalir', role: 'Tamil & English Poet', imageBg: 'bg-ink-900/10' },
  { name: 'Niman', slug: 'niman', role: 'Medical Professional & Author', imageBg: 'bg-ink-900/5' },
  { name: 'Rajesh Tiwari', slug: 'rajesh', role: 'Principal & Author', imageBg: 'bg-ink-900/10' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold font-serif text-ink-900 mb-8 leading-tight">
              Meet Our <br/><span className="italic font-light">Authors.</span>
            </h1>
            <p className="text-lg text-ink-600 font-sans font-light leading-relaxed mb-12">
              From epic fantasy to raw poetry, these are the writers who are changing the book world. 
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-ink-900/10 border border-ink-900/10">
            {authors.map((author, idx) => (
              <Link 
                key={author.name}
                href={`/publishedauthor/${author.slug}`} 
          ...
          <div className="mt-24 text-center pb-24 border-b border-ink-900/10">
            ...
            <Link href="/learning/15-day-guide">
              <Button className="bg-ink-900 text-[#FDFBF7] rounded-none px-12 py-6 text-sm font-sans uppercase tracking-[0.2em] hover:bg-gold hover:text-ink-900 transition-all font-bold">
