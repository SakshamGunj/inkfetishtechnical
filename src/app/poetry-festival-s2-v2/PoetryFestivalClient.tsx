...
export default function PoetryFestivalClient() {
  ...
  const faqs = [
    ...
    { q: 'Is there any registration fee?', a: 'Poetry Festival Season 2 (Community Edition) is completely free to enter. There are no hidden charges or entry fees.' },
    ...
    <div className="min-h-screen bg-[#050505] text-[#fdfbf7] font-sans selection:bg-gold selection:text-black overflow-x-hidden">
      ...
      <section className="relative flex flex-col overflow-hidden pt-4 md:pt-12 pb-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            <Link href="/poetry-festival-s2-v2/register" className="relative group w-full sm:w-auto">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="relative">
            ...
            <div className="space-y-12 sm:space-y-16 relative z-10">
              {[
                { step: 1, title: 'Register & Access', desc: 'Pick your category and complete registration. Your seat is immediately reserved in the anthology — 100% Free.', color: 'border-gold text-gold shadow-[0_0_20px_rgba(197,160,89,0.3)]' },
          ...
          <div className="text-center mt-16">
            <Link href="/poetry-festival-s2-v2/register">
            ...
            <div className="bg-[#0a0a0a]/90 backdrop-blur-sm border border-white/10 p-8 md:p-12 rounded-sm shadow-2xl max-w-md mx-auto">
              ...
              <div className="flex items-center justify-between mb-6 p-4 bg-[#050505] border border-white/5 rounded-sm">
                <div className="text-left">
                  ...
                  <div className="text-2xl font-black font-serif text-[#fdfbf7]">FREE</div>
                </div>
              ...
              <Link href="/poetry-festival-s2-v2/register" className="block w-full mb-4">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 text-[#555] text-[9px] uppercase tracking-widest font-bold">
                <div className="flex items-center justify-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5 text-green-500" /> Community Edition</div>
                <div className="flex items-center justify-center gap-1.5"><CheckCircle2 className="w-3.5 h-3.5 text-gold" /> Instant Access</div>
              </div>
            </div>
